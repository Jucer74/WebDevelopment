...
/**
 * Generate a delete form for an Subject and when submit, delete an entry
  ...
  return (
    <>
      <Form onSubmit={handleSubmit}>
        <p>
          Are you sure you want to delete it? All student enrollments in this
