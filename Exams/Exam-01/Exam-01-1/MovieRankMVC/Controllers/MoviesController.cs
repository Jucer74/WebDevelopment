    ...
    public class MoviesController : Controller
    {
        private static List<Movie> LoadMovies()
        {
            List<Movie> movies = new()
            {
                ...
                new Movie() { Id = 11, Title = "Avengers: Endgame", Synopsis = "Tras los devastadores eventos de Infinity War, los Vengadores se reúnen para deshacer las acciones de Thanos.", Year = 2019, Duration = "03:01", Rate = 8.4f, Poster = "Avengers-Endgame.jpg", Genres = "Acción | Aventura | Ciencia Ficción" },
                new Movie() { Id = 12, Title = "Indiana Jones and the Dial of Destiny", Synopsis = "El arqueólogo Indiana Jones corre contra el tiempo para recuperar un legendario artefacto que puede cambiar el curso de la historia.", Year = 2023, Duration = "02:34", Rate = 6.8f, Poster = "Indiana-jones-and-the-dial-of-destiny.jpg", Genres = "Acción | Aventura" },
