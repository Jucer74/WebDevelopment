...
public class MovieService
{
    ...
    private static List<Movie>? LoadMovies()
    {
        ...
        movies.Add(new Movie
        {
            ...
            Rate = 6.7,
            Poster =
                "https://m.media-amazon.com/images/M/MV5BYjMwZDMwZTItMTc2MC00NDRlLWI3YmUtNTg0ZmQ3MzdhNDJmXkEyXkFqcGdeQXVyNjQ2MjQ5NzM@._V1_SY1000_SX677_AL_.jpg",
        ...
        movies.Add(new Movie
        {
            ...
            Synopsis =
                "A story of life on an Indian reservation in Ontario: Silas and Frank are trying to get into college to train to be mechanics but they find themselves having to deal with girls, family ... and murder.",
            Year = 1994,
            Duration = "1H:24M",
            Rate = 7.3,
            Poster =
                "https://m.media-amazon.com/images/M/MV5BNjQ0NTU4NjI5OV5BMl5BanBnXkFtZTYwMzE0MTg4._V1_SY1000_SX677_AL_.jpg",
            Genres = "Comedy|Drama"
        });
        movies.Add(new Movie
        {
            ...
            Rate = 6.4,
            Poster =
                "https://m.media-amazon.com/images/M/MV5BOWNjMGQ2NTYtNWZlMS00Nzk4LWE5ZDQtNWFhZDk0ZWM3ODc4XkEyXkFqcGdeQXVyMTQxNzMzNDI@._V1_SY1000_SX677_AL_.jpg",
        ...
        movies.Add(new Movie
        {
            ...
            Synopsis =
                "While Frodo and Sam, now accompanied by a new guide, continue their hopeless journey towards the land of shadow to destroy the One Ring.",
            Year = 2002,
            Duration = "2H59M",
            Rate = 8.7,
            Poster =
        ...
        movies.Add(new Movie
        {
            ...
            Synopsis =
                "While Frodo & Sam continue to approach Mount Doom to destroy the One Ring, Gandalf and Aragorn lead the World of Men against Sauron's army.",
            Year = 2003,
            Duration = "3H21M",
            Rate = 8.9,
            Poster =
    ...
    public void UpdateMovie(int id, Movie editedMovie)
    {
        Movie movie = _movies.FirstOrDefault(m => m.Id == id);
        if (movie != null)
        {
            movie.Title = editedMovie.Title;
            movie.Synopsis = editedMovie.Synopsis;
            movie.Year = editedMovie.Year;
            movie.Duration = editedMovie.Duration;
            movie.Rate = editedMovie.Rate;
            movie.Poster = editedMovie.Poster;
            movie.Genres = editedMovie.Genres;
        }
    }
