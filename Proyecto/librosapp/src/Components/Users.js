...
export function ListUsers() {
  ...
  return (
    <div className="text-center text-md-left col-10 m-auto">
      <h1>User List</h1>
      <p>
        <Button
          className="left"
          ...
          <Form>
            <Form.Group>
              ...
              <Form.Control
                ...
                required
                value={currentUser.userEmail} // Corregido a currentUser.email
            ...
            <Form.Group>
              ...
              <Form.Control
                ...
                placeholder="Julio"
                required
                value={currentUser.firstName} // Corregido a currentUser.name
                onChange={handleChange}
              />
            </Form.Group>
            <Form.Group>
              ...
              <Form.Control
                ...
                placeholder="Robles"
                required
                value={currentUser.lastName} // Corregido a currentUser.username
                onChange={handleChange}
              />
            </Form.Group>
            <Form.Group>
